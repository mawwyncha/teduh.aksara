...
interface LayoutProps {
  ...
  activeModal: 'history' | 'guide' | 'dev' | null;
  onHistoryClick: () => void;
  onGuideClick: () => void;
  onDevClick: () => void;
  onEditorClick: () => void;
  ...
  return (
    <div className="min-h-screen bg-[#faf9f6] dark:bg-[#050a08] flex flex-col items-center p-4 md:p-8 text-[#1a0f0e] dark:text-emerald-50 transition-colors duration-700 pb-24 lg:pb-8">
      ...
      <nav className="fixed bottom-4 left-4 right-4 h-24 bg-white/90 dark:bg-[#1a110c]/80 backdrop-blur-xl rounded-[2.5rem] shadow-xl border border-white/20 flex items-center justify-around px-2 z-[80] lg:hidden">
        <button onClick={onEditorClick} className={`${mobileNavClass} ${activeModal === null ? mobileNavActiveClass : ''}`}>
        ...
        <button onClick={onHistoryClick} className={`${mobileNavClass} ${activeModal === 'history' ? mobileNavActiveClass : ''}`}>
        ...
        <button onClick={onGuideClick} className={`${mobileNavClass} ${activeModal === 'guide' ? mobileNavActiveClass : ''}`}>
        ...
        <button onClick={onDevClick} className={`${mobileNavClass} ${activeModal === 'dev' ? mobileNavActiveClass : ''}`}>
